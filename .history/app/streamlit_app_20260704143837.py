...
# ✅ GUNAKAN PEAK HOUR STANDARD (BUKAN INPUT USER)
peak_standard = 3.0  # ← Nilai standard/rata-rata
...
input_dengan_ac = pd.DataFrame({
    ...
    'Avg_Temperature_C': [temp],
    'Has_AC': [1],
    'Peak_Hours_Usage_kWh': [peak_standard]  # ← UBAH KE STANDARD
})
...
# Catatan
st.info(f"⚠️ **Catatan:** Perbandingan menggunakan Peak Hour Usage standard {peak_standard} kWh untuk fair comparison")
