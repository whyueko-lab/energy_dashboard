...
with tab5:
    ...
    # ===== TAMBAHAN: PERBANDINGAN AC VS TANPA AC =====
    ...
    # Prediksi TANPA AC (input lain sama)
    ...
    st.info(f"**Perbedaan:** {selisih:.2f} kWh ({persen_selisih:.1f}% lebih tinggi dengan AC)")
    ...
    # =========================
    # PERBAIKAN: Evaluasi Model dengan Data Split
    # =========================
    st.subheader("Evaluasi Model")
    
    # Split data sama seperti di train_model.py
